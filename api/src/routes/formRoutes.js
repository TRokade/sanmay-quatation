...
const pricing = {
    LivingRoom: {
        ...
        'None': { price: 0, size: '', description: 'No items selected for this room' }
    },
    Kitchen: {
    ...
    MasterBedroom: {
        ...
        "Wardrobe + Lofts": { price: 0, size: "", description: "Not defined yet" },
        ...
        "Study": { price: 16200, size: "3ft X 2.5ft", description: "2 drawer study unit with 3 wall mounted shelwes" },
        'None': { price: 0, size: '', description: 'No items selected for this room' }
...
const options = {
    '1 BHK': {
        ...
        MasterBedroom: ['Wardrobe', "Lofts on Wardrobe", 'Bed', 'Bed Side Tables', 'Dresser', 'Study', "Vanity", "Wardrobe + Lofts"],
        Services: {
            WholeHousePainting: ['Enter Carpet Area'],
            FalseCeilingElectrical: ['Fire pipe Boxing', 'Basic', 'Peripheral', 'Custom Design', "None"]
        }
    },
    '2 BHK': {
        LivingRoom: ['TV Unit', 'Sofa', 'Crockery Unit', 'Shoe Rack', 'Console'],
    ...
    '3 BHK': {
        ...
        MasterBedroom: ['Wardrobe', "Lofts on Wardrobe", 'Bed', 'Bed Side Tables', 'Dresser', 'Study', "Vanity", "Wardrobe + Lofts"],
        CommonBedroom: ['Wardrobe', "Lofts on Wardrobe", 'Bed', 'Bed Side Tables', 'Dresser', 'Study'],
        MasterBedroom2: ['Wardrobe', "Lofts on Wardrobe", 'Bed', 'Bed Side Tables', 'Dresser', 'Study', "Vanity", "Wardrobe + Lofts"],
        Services: {
            WholeHousePainting: ['Enter Carpet Area'],
            FalseCeilingElectrical: ['Fire pipe Boxing', 'Basic', 'Peripheral', 'Custom Design', "None"]
        }
...
async function sendThankYouEmail(email) {
    const mailOptions = {
        ...
        html: `
            ...
            <p>We noticed you haven't selected any specific interior design options at this time. 
            We'd love to understand your needs better and discuss how we can help create your dream space.</p>
            <p>Feel free to:</p>
            <ul>
                <li>Reply to this email with your questions</li>
                <li>Call us at [your phone number]</li>
                <li>Visit our website at <a href="www.warsto.com">www.warsto.com</a></li>
            </ul>
            <p>We're here to help you make the best decisions for your home!</p>
        `
    };
...
router.post('/submit', async (req, res) => {
    try {
        ...
        const hasOnlyNoneSelections = Object.entries(req.body.selectedOptions).every(
            ([_, options]) =>
                options.length === 0 ||
                (options.length === 1 && options[0] === 'None')
        );

        // If only "None" options are selected and no painting is selected
        if (hasOnlyNoneSelections && !req.body.wholePaintingSelected) {
            // Send thank you email instead of quotation
        ...
        // Process painting options if selected
        if (req.body.wholePaintingSelected && req.body.carpetArea) {
